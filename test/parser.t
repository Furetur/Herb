  $ herbc --dump-ast ../../../../../test/parser/000_empty.herb
  { Ast.decls = [] }
  $ herbc --dump-ast ../../../../../test/parser/001_empty_entry.herb
  { Ast.decls = [(Ast.AEntry [])] }
  $ herbc --dump-ast ../../../../../test/parser/002_simple_arithmetics.herb
  { Ast.decls =
    [(Ast.AEntry
        [(Ast.AExprStmt
  ...
  $ herbc --dump-ast ../../../../../test/parser/003_complex_arithmetics.herb
  { Ast.decls =
    [(Ast.AEntry
        [(Ast.AExprStmt
            (Ast.ABinOp (
  ...
  $ herbc --dump-ast ../../../../../test/parser/004_assign_associativity.herb
  { Ast.decls =
    [(Ast.AEntry
        [(Ast.AExprStmt
  ...
  $ herbc --dump-ast ../../../../../test/parser/005_toplevel_let.herb
  { Ast.decls = [(Ast.AToplevelLet ("f", (Ast.ALiteral (Ast.AInt 14))))] }
  $ herbc --dump-ast ../../../../../test/parser/006_if_expr.herb
  { Ast.decls =
  ...
  $ herbc --dump-ast ../../../../../test/parser/007_fun_call.herb
  { Ast.decls =
    [(Ast.AToplevelLet
        ("x",
  ...
  $ herbc --dump-ast ../../../../../test/parser/008_fun_literal.herb
  { Ast.decls =
    [(Ast.AToplevelLet
        ("f",
         (Ast.ALiteral
  ...
  $ herbc --dump-ast ../../../../../test/parser/009_local_let.herb
  File '../../../../../test/parser/009_local_let.herb', line 3, column 12:
  Error: Syntax error
  $ herbc --dump-ast ../../../../../test/parser/010_fact.herb
  { Ast.decls =
    [(Ast.AToplevelLet
        ("fact",
         (Ast.ALiteral
  ...
  $ herbc --dump-ast ../../../../../test/parser/011_imports.herb
  File '../../../../../test/parser/011_imports.herb', line 1, column 0:
  Error: Syntax error
  $ herbc --dump-ast ../../../../../test/parser/012_string_literal.herb
  { Ast.decls =
  ...
  $ herbc --dump-ast ../../../../../test/parser/013_for_numeric.herb
